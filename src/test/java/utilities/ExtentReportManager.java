...
public class ExtentReportManager implements ITestListener{
	...
	public void onFinish(ITestContext testContext) {
	    extent.flush(); // Write all logs and complete the report

	    String pathOfExtentReport = System.getProperty("user.dir") + "\\reports\\" + repName; // Generate the path for the report
